	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'mysettings.general.email', placeholder: 'E-Mail Address', id: 'generalMail', onChange: settingsChanged, defaultValue: settings['mysettings.general.email'] })
	                ),
	                _react2.default.createElement(
	                  'fieldset',
	                  { className: 'form-group' },
	                  ...
	                  _react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'mysettings.general.picture', placeholder: 'Picture', id: 'generalPic', onChange: settingsChanged, defaultValue: settings['mysettings.general.picture'] })
	                ),
	                _react2.default.createElement(
	                  'fieldset',
	                  { className: 'form-group' },
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'mysettings.profile.firstname', placeholder: 'Firstname', id: 'profileFirstname', onChange: settingsChanged, defaultValue: settings['mysettings.profile.firstname'] })
	                ),
	                _react2.default.createElement(
	                  'fieldset',
	                  { className: 'form-group' },
	                  ...
	                  _react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'mysettings.profile.lastname', placeholder: 'Lastname', id: 'profileLastname', onChange: settingsChanged, defaultValue: settings['mysettings.profile.lastname'] })
	                ),
	                _react2.default.createElement(
	                  'fieldset',
	                  { className: 'form-group' },
	                  ...
	                  _react2.default.createElement('textarea', { className: 'form-control', name: 'mysettings.profile.biography', placeholder: 'Biography', id: 'profileBiography', onChange: settingsChanged, defaultValue: settings['mysettings.profile.biography'] })
	                )
	              )
	            )
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	validatedFactory.type=type;if(process.env.NODE_ENV!=='production'){if(canDefineProperty){Object.defineProperty(validatedFactory,'type',{enumerable:false,get:function get(){process.env.NODE_ENV!=='production'?warning(false,'Factory.type is deprecated. Access the class directly '+'before passing it to createFactory.'):void 0;Object.defineProperty(this,'type',{value:type});return type;}});}}return validatedFactory;},cloneElement:function cloneElement(element,props,children){var newElement=ReactElement.cloneElement.apply(this,arguments);for(var i=2;i<arguments.length;i++){validateChildKeys(arguments[i],newElement.type);}validatePropTypes(newElement);return newElement;}};module.exports=ReactElementValidator; /* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(1)); /***/}, /* 14 */ /***/function(module,exports,__webpack_require__){ /* WEBPACK VAR INJECTION */(function(process){ /**
		 ...
		 */var keyMirror=function keyMirror(obj){var ret={};var key;!(obj instanceof Object&&!Array.isArray(obj))?process.env.NODE_ENV!=='production'?invariant(false,'keyMirror(...): Argument must be an object.'):invariant(false):void 0;for(key in obj){if(!obj.hasOwnProperty(key)){continue;}ret[key]=key;}return ret;};module.exports=keyMirror; /* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(1)); /***/}, /* 19 */ /***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(5);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&((typeof call==='undefined'?'undefined':_typeof(call))==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+(typeof superClass==='undefined'?'undefined':_typeof(superClass)));}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;} /*
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @react-settings-pane
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */var MenuItem=function(_Component){_inherits(MenuItem,_Component);function MenuItem(){_classCallCheck(this,MenuItem);return _possibleConstructorReturn(this,Object.getPrototypeOf(MenuItem).apply(this,arguments));}_createClass(MenuItem,[{key:'clicked', /**
		     * MenuItem was clicked
		     *
		     * @param ev
		     */value:function clicked(ev){ev.preventDefault(); // If this is not a left click
	if(ev.button!==0){return;}if(this.props.onMenuItemClick){this.props.onMenuItemClick(this.props.item);}this.props.switchContent(this.props.item);} /**
		     ...
		     *
		     * @returns {XML}
		     */},{key:'render',value:function render(){var _props$item=this.props.item;var title=_props$item.title;var url=_props$item.url;var itemsClassName=this.props.active?'menu-item active':'menu-item';return _react2.default.createElement('li',{title:title,className:itemsClassName},_react2.default.createElement('a',{href:url,onClick:this.clicked.bind(this)},title));}}]);return MenuItem;}(_react.Component);MenuItem.propTypes={item:_react.PropTypes.object.isRequired,switchContent:_react.PropTypes.func.isRequired,onMenuItemClick:_react.PropTypes.func};exports.default=MenuItem; /***/}, /* 20 */ /***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(5);var _react2=_interopRequireDefault(_react);var _SettingsFooter=__webpack_require__(21);var _SettingsFooter2=_interopRequireDefault(_SettingsFooter);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&((typeof call==='undefined'?'undefined':_typeof(call))==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+(typeof superClass==='undefined'?'undefined':_typeof(superClass)));}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;} /*
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @react-settings-pane
	...
	if(page.length===0){page=[_react2.default.createElement('div',{key:'settingsEmptyMessage',className:'empty-message'},_react2.default.createElement('p',null,'Page not defined'))];}return page;} /**
		     ...
		     * Close was clicked
		     */value:function closeClicked(){this.props.onPaneLeave(false,this.props.settings,this.props.settings);} /**
		     * Save was clicked
		     */ /**
		     * PropTypes
		     *
		     * @type {{settings: *, onPaneLeave: *}}
		     */},{key:"saveClicked",value:function saveClicked(){this.props.onPaneLeave(false,this.props.settings,this.props.settings);} /**
		     * Render this component
		     *
		     * @returns {XML}
		     */},{key:"render",value:function render(){return _react2.default.createElement("div",{className:"settings-footer"},_react2.default.createElement("div",{className:"settings-close"},_react2.default.createElement("button",{className:"btn btn-default",onClick:this.closeClicked.bind(this)},"Close")),_react2.default.createElement("button",{className:"btn btn-primary",onClick:this.saveClicked.bind(this)},"Save"));}}]);return SettingsPage;}(_react.Component);SettingsPage.propTypes={settings:_react.PropTypes.object.isRequired,onPaneLeave:_react.PropTypes.func.isRequired};exports.default=SettingsPage; /***/}, /* 22 */ /***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(5);var _react2=_interopRequireDefault(_react);var _MenuItem=__webpack_require__(19);var _MenuItem2=_interopRequireDefault(_MenuItem);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&((typeof call==='undefined'?'undefined':_typeof(call))==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+(typeof superClass==='undefined'?'undefined':_typeof(superClass)));}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;} /*
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @react-settings-pane
	...
	return _react2.default.createElement("div",null,"Render With Options (not implemented, yet)");} /**
		   ...
		   *
		   * @param props
		   */function SettingsPane(props){_classCallCheck(this,SettingsPane);var _this=_possibleConstructorReturn(this,Object.getPrototypeOf(SettingsPane).call(this,props));_this.state={currentPage:props.index,items:props.items,settings:props.settings};return _this;} /**
		   ...
		   */_createClass(SettingsPane,[{key:'switchContent',value:function switchContent(menuItem){ // Check if currentPage is different than the new urls
	...
	return _react2.default.createElement('div',{className:'settings-pane'},_react2.default.createElement('form',{ref:function ref(_ref){return _this2.form=_ref;},className:'settings',onSubmit:this.handleSubmit.bind(this)},childrenWithProps));}}]);return SettingsPane;}(_react.Component);SettingsPane.propTypes={children:_react.PropTypes.node.isRequired,settings:_react.PropTypes.object.isRequired,items:_react.PropTypes.array.isRequired,index:_react.PropTypes.string.isRequired,onChange:_react.PropTypes.func,onPaneLeave:_react.PropTypes.func,onMenuItemClick:_react.PropTypes.func};exports.default=SettingsPane; /***/}, /* 25 */ /***/function(module,exports){ // get successful control from form and assemble into object

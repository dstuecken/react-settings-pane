...
/***/ function(module, exports, __webpack_require__) {
	...
	if(page.length===0){page=[_react2.default.createElement('div',{key:'settingsEmptyMessage',className:'empty-message'},_react2.default.createElement('p',null,'Page not defined'))];}return page;} /**
		     ...
		     */},{key:'render',value:function render(){var page=this.props.currentPage?this.props.currentPage:'',header='';if(this.props.header){if(this.props.header===true){var currentItem=this.props.items.reduce(function(prev,item){return item.url===page?item:prev;});header=_react2.default.createElement('div',{className:'headline'},_react2.default.createElement('h3',null,currentItem.title));}else {header=this.props.header;}}return _react2.default.createElement('div',{className:'settings-content'},header,_react2.default.createElement('div',{className:'settings-page'},_react2.default.createElement('div',{className:'scroller-wrap'},this.renderPage(page))),_react2.default.createElement(_SettingsFooter2.default,this.props));}}]);return SettingsContent;}(_react.Component);SettingsContent.propTypes={currentPage:_react.PropTypes.string,header:_react.PropTypes.bool,items:_react.PropTypes.array,settings:_react.PropTypes.object,onChange:_react.PropTypes.func,switchContent:_react.PropTypes.func,onPaneLeave:_react.PropTypes.func,onMenuItemClick:_react.PropTypes.func};exports.default=SettingsContent; /***/}, /* 21 */ /***/function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.SettingsPage=undefined;var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(5);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&((typeof call==='undefined'?'undefined':_typeof(call))==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+(typeof superClass==='undefined'?'undefined':_typeof(superClass)));}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;} /**
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @copyright Dennis Stücken
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * @licence MIT
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */var SettingsPage=exports.SettingsPage=function(_Component){_inherits(SettingsPage,_Component);function SettingsPage(props){_classCallCheck(this,SettingsPage);var _this=_possibleConstructorReturn(this,Object.getPrototypeOf(SettingsPage).call(this,props));_this.closeClicked=_this.closeClicked.bind(_this);return _this;} /**
		   * Close was clicked
		   */ /**
		   * PropTypes
		   *
